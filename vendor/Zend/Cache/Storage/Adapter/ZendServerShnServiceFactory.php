...
class ZendServerShnServiceFactory implements FactoryInterface {
	/**
	...
	public function createService(ServiceLocatorInterface $serviceLocator) {
		...
		$options = $config ['cachestorage'] ['zendservershn'];
		
		$cache = StorageFactory::adapterFactory ( 'zendservershn' );
