...
class FormSearchUser extends AbstractFormHelper {
	/**
	...
	public function render(ElementInterface $element) {
		...
		$searchpermission = $element->getOption ( 'searchpermission' );
		$searchpermission = (empty ( $searchpermission ) ? '' : '{ searchpermission : "' . $searchpermission . '" }');
		...
		$(document).ready(function() {	
			$(this).UserSearch(' . $searchpermission . ');
    	});
		</script>';
