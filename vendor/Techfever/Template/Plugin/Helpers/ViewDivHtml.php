...
class ViewDivHtml extends AbstractViewHelper {
	/**
	...
	public function render(ElementInterface $element) {
		...
		return sprintf ( '<div %s><div class="label">%s :</div><div class="value">%s</div></div>', $this->createAttributesString ( $attributes ), $escapeHtml ( $label ), $content );
	}
