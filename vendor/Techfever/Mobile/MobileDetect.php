...
use Techfever\Exception\BadMethodCallException;
/**
...
class MobileDetect
{
    ...
    public function prepareVersionNo($ver)
    {
        ...
        if (isset($arrVer[1])) {
            $arrVer[1] = @str_replace('.', '', $arrVer[1]); // treat strings versions.
        }
    ...
    public function mobileGrade()
    {
        ...
        if (
            // Apple iOS 4-7.0 Ð Tested on the original iPad (4.3 / 5.0), iPad 2 (4.3 / 5.1 / 6.1), iPad 3 (5.1 / 6.0), iPad Mini (6.1), iPad Retina (7.0), iPhone 3GS (4.3), iPhone 4 (4.3 / 5.1), iPhone 4S (5.1 / 6.0), iPhone 5 (6.0), and iPhone 5S (7.0)
        ...
        if (
            ...
            // report this (tested on Nokia N71)
