...
class ListActionController extends AbstractActionController {
	...
	public function IndexAction() {
		...
		Template::addCSS("vendor/Techfever/Javascript/jquery/themes/jtable/lightcolor/gray/jtable.css");
		Template::addJavascript('vendor/Techfever/Javascript/jquery/ui/jquery.jtable.js');
		Template::addJavascript("vendor/Techfever/Theme/" . SYSTEM_THEME . "/Js/datatable.menu.js",
				array(
						'datatableid' => $this->getMatchedRouteName() . '/Datatable',
		...
		if ($Request->isXmlHttpRequest()) {
			...
			if (is_array($search) && count($search) > 0) {
				...
				foreach ($search as $searchkey => $searchvalue) {
					//$searchkey = str_replace('search_', '', $searchkey);
