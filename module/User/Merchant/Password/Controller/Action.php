...
namespace User\Merchant\Password\Controller;
	...
	public function UpdateAction() {
		...
		if ($this->isXmlHttpRequest ()) {
			...
			if ($InputForm->isPost () && $InputForm->isValid () && $action == 'submit') {
				...
				if ($this->getUserManagement ()->verifyID ( $id, $this->rankgroup, null ) && $this->getUserManagement ()->updatePassword ( $id, $data )) {
