...
namespace User\Merchant\Username\Controller;
	...
	public function UpdateAction() {
		...
		if ($this->isXmlHttpRequest ()) {
			...
			if ($InputForm->isPost () && $InputForm->isValid () && $action == 'submit') {
				...
				$data ['user_username_old'] = $this->getUserManagement ()->getUsername ( $id );
				if ($this->getUserManagement ()->verifyID ( $id, $this->rankgroup, null ) && $this->getUserManagement ()->updateUsername ( $id, $data )) {
