...
namespace User\Member\Register\Controller;
...
class ActionController extends AbstractActionController {
	...
	protected function CSS() {
		return array (
				"Theme/" . SYSTEM_THEME_LOAD . "/css/" . SYSTEM_THEME_SUFFIX . "/steps.css" 
		);
	}
	...
	protected function Javascript() {
		return array (
				"Theme/" . SYSTEM_THEME_LOAD . "/js/" . SYSTEM_THEME_SUFFIX . "/address.js",
				"Theme/" . SYSTEM_THEME_LOAD . "/js/" . SYSTEM_THEME_SUFFIX . "/bank.js",
				"Theme/" . SYSTEM_THEME_LOAD . "/js/" . SYSTEM_THEME_SUFFIX . "/rank.js" 
		);
	}
