...
namespace User\Member\Activation\Approve\Controller;
...
class ActionController extends AbstractActionController {
	 ...
	 *
	 */
	protected $module = 'activation_approve';
	/**
	 *
	 * @var Input Form
	 *     
	...
	public function UpdateAction() {
		...
		if ($this->isXmlHttpRequest ()) {
			...
			if ($InputForm->isPost () && $InputForm->isValid () && $action == 'submit') {
				...
				if ($this->getUserManagement ()->verifyID ( $id, $this->rankgroup, null ) && $this->getUserManagement ()->updateActivation ( $id, $data )) {
