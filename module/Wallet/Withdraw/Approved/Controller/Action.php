...
namespace Wallet\Withdraw\Approved\Controller;
...
class ActionController extends AbstractActionController {
	 ...
	 *
	 */
	protected $module = 'withdraw_approved';
			...
			$legend ['print'] = $this->HrefLink ( array (
					...
					'attributes' => array (
							...
							'onclick' => '$(this).formDialogPreview({
												uri: "' . $this->url ()->fromRoute ( ucfirst ( str_replace ( '_', '/', $this->type ) ) . '/Withdraw/Approved', array (
									'action' => 'View',
									'query' => $id 
							) ) . '",  
