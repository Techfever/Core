...
class ApprovedActionController extends AbstractActionController {
	protected $type = 'Wallet_Withdraw';
	protected $module = 'approved';
	...
	public function IndexAction() {
		...
		$this->addJavascript ( "vendor/Techfever/Theme/" . SYSTEM_THEME . "/Js/datatable.menu.js", array (
				...
				'datalisturi' => $this->url ()->fromRoute ( ucfirst ( str_replace ( '_', '/', $this->type ) ) . '/Approved' ),
	...
	public function GetAction() {
		...
		if ($Request->isXmlHttpRequest ()) {
			...
			$search ['user_wallet_history'] [] = 'uwh.wallet_status_id = 3';
			if (! $this->isAdminUser ()) {
			...
			$legend ['print'] = $this->HrefLink ( array (
					...
					'attributes' => array (
							...
							'onclick' => '$(this).formDialogPreview({
												uri: "' . $this->url ()->fromRoute ( ucfirst ( str_replace ( '_', '/', $this->type ) ) . '/Approved', array (
									'action' => 'View',
									'query' => $id 
							) ) . '",  
