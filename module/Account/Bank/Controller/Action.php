			...
			if ($InputForm->isPost()) {
				if ($InputForm->isValid()) {
					...
					if ($submit == 'submit') {
						...
						if ($this->getUserManagement()->verifyID($id) && $this->getUserManagement()->updateBank($id, $data)) {
