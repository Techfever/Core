...
class ZendServerDiskServiceFactory implements FactoryInterface {
	/**
	...
	public function createService(ServiceLocatorInterface $serviceLocator) {
		...
		$options = $config ['cachestorage'] ['zendserverdisk'];
		
		$cache = StorageFactory::adapterFactory ( 'zendserverdisk' );
